...
class CommandRegistry(object):
  ...
  def AddCommandForMethod(self, service_name, method_name, method_info,
    ...
    if method_info.upload_config:
      ...
      upload_flag_info = FlagInfo(
          ...
          description='Filename to use for upload.', fv='fv', special=True)
    ...
    if method_info.supports_download:
      download_flag_info = FlagInfo(
          ...
          description='Filename to use for download.', fv='fv', special=True)
  ...
  def __LookupMessage(self, message, field):
    ...
    if message_type is None:
      message_type = self.__message_registry.LookupDescriptor(field.type_name)
    return message_type
    ...
    if field.variant in (messages.Variant.MESSAGE, messages.Variant.ENUM):
      if field.type_name.startswith('protorpc.'):
        ...
        if field_message is None:
          raise ValueError('Could not find type for field %s' % field.name)
  ...
  def __PrintPyShell(self, printer):
    ...
    with printer.Indent():
      ...
      with printer.Indent():
        printer('"""Run an interactive python shell with the client."""')
  ...
  def WriteFile(self, printer):
    ...
    printer('# NOTE: This file is autogenerated and should not be edited by '
            'hand.')
  ...
  def __PrintCommands(self, printer):
    ...
    for command_info in self.__command_list:
      ...
      with printer.Indent():
        ...
        with printer.Indent():
          printer('super(%s, self).__init__(name, fv)', command_info.class_name)
        ...
        with printer.Indent():
          ...
          printer('request = messages.%s(', command_info.request_type)
          with printer.Indent(indent='    '):
